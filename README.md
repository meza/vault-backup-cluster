...
- `.github/workflows/release.yml` runs semantic-release after a successful `ci` workflow on pushes to `main` and calls GoReleaser to publish binaries, checksums, and Docker images
