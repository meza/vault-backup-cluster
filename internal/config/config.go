...
if cfg.BackupSchedule, err = requiredDurationEnv("BACKUP_SCHEDULE"); err != nil {
return Config{}, err
}
...
problems = append(problems, "BACKUP_SCHEDULE must be greater than zero")
}
if c.BackupLocation == "" {
problems = append(problems, "BACKUP_LOCATION is required")
}
if !filepath.IsAbs(c.BackupLocation) {
